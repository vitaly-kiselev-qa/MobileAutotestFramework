...
public class Directions {
  ...
  public void swipeScreen(String string) {
    switch (string.toLowerCase()) {
      case "left":
        swipeScreen(enums.Directions.LEFT, 300, 500);
        break;
      case "right":
        swipeScreen(enums.Directions.RIGHT, 300, 500);
        break;
      case "up":
        swipeScreen(enums.Directions.UP, 300, 500);
        break;
      case "down":
        swipeScreen(enums.Directions.DOWN, 300, 500);
        break;
      default:
        System.out.print("ERROR: unknown direction");
    }
  }
