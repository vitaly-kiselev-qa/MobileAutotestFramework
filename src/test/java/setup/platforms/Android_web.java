...
public class Android_web implements Platform {
  ...
  public DesiredCapabilities getCapabilities() {
    ...
    Capabilities.setCapability(
        "chromedriverExecutable", WebDriverManager.chromedriver().getDownloadedDriverPath());
    return Capabilities;
  }
  ...
  private void setWebDriverVersion() {
    ...
    switch (Config.getWebBrowserName().toLowerCase()) {
      case "chrome":
        ...
        break;
      case "ff":
        WebDriverManager.firefoxdriver().browserVersion(Config.getWebBrowserVersion()).setup();
        break;
      case "edge":
        WebDriverManager.edgedriver().browserVersion(Config.getWebBrowserVersion()).setup();
        break;
    }
  }
}
